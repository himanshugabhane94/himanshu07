...
def seed_database():
    ...
    narco_nodes = [
        ...
        Node(id="LOC_MAYAPURI_GODOWN", label="Mayapuri Secret Chemical Godown", type=NodeType.LOCATION, risk_level=RiskLevel.HIGH, case_ids=["CASE-NARCO-2024"], discovered_date="2024-02-16T15:00:00Z", properties={"city": "New Delhi", "type": "Synthetic Processing Lab"}),
        ...
        Node(id="LOC_DHARAVI_DISPENSARY", label="Dharavi Street Distribution Hub", type=NodeType.LOCATION, risk_level=RiskLevel.HIGH, case_ids=["CASE-NARCO-2024"], discovered_date="2024-02-28T19:00:00Z", properties={"city": "Mumbai", "type": "Retail Distribution Point"}),
        ...
        Node(id="LOC_WAGAH_BORDER_POST", label="Wagah Outpost Point #4", type=NodeType.LOCATION, risk_level=RiskLevel.CRITICAL, case_ids=["CASE-NARCO-2024"], discovered_date="2024-03-12T16:00:00Z", properties={"type": "Night Drop Coordinate", "border_fence": "BOP 44/2"}),
    ...
    kidnap_nodes = [
        ...
        Node(id="LOC_ALWAR_KILN", label="Abandoned Brick Kiln (Alwar Border)", type=NodeType.LOCATION, risk_level=RiskLevel.HIGH, case_ids=["CASE-KIDNAP-2024"], discovered_date="2024-02-13T16:00:00Z", properties={"type": "Hostage Confinement Safehouse", "coordinates": "27.5530, 76.6346"}),
        ...
        Node(id="LOC_SAKET_METRO", label="Saket PVR Parking Abduction Point", type=NodeType.LOCATION, risk_level=RiskLevel.MEDIUM, case_ids=["CASE-KIDNAP-2024"], discovered_date="2024-02-10T11:15:00Z", properties={"city": "New Delhi", "type": "Abduction Scene"})
    ]
